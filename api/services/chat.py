...
TOOLS = [
    ...
    },
    {
    ...
    },
      {
        ...
        "function": {
            "name": "media_idade",
            "description": "Calcula a média de idade dos alunos cadastrados",
            "parameters": {
                "type": "object",
                "properties": {}
            }
    ...
    },
    {
        ...
        "function": {
            "name": "contar_alunos",
            "description": "Conta o número de alunos cadastrados",
            "parameters": {
                "type": "object",
                "properties": {}
            }
    ...
    },
    {
        "type": "function",
        "function": {
            "name": "atualizar_idade_professor",
            "description": "Atualiza a idade de um professor.",
            "parameters": {
                "type": "object",
                "properties": {
                    "nome": {"type": "string"},
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "Remove um professor pelo nome.",
            "parameters": {
                "type": "object",
                "properties": {"nome": {"type": "string"}},
                "required": ["nome"],
    ...
    },
    {
    ...
    },
      {
        "type": "function",
        "function": {
            "name": "media_idade_professores",
            "description": "Calcula a média de idade dos professores cadastrados",
            "parameters": {
                "type": "object",
                "properties": {}
            }
    ...
    },
    {
        "type": "function",
        "function": {
            "name": "contar_professores",
            "description": "Conta o número de professores cadastrados",
            "parameters": {
                "type": "object",
                "properties": {}
            }
...
def responder_com_mcp(instruction: str):
    ...
    tool_events = []
    chart = None # Será usado para armazenar o gráfico gerado, caso seja gerado.
